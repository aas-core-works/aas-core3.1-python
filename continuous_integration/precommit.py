...
def main() -> int:
    ...
    # TODO redo for pyproject.toml
    # if (
    #     Step.CHECK_INIT_AND_SETUP_COINCIDE in selects
    #     and Step.CHECK_INIT_AND_SETUP_COINCIDE not in skips
    # ):
    #     print("Checking that aas_core3_1/__init__.py and setup.py coincide...")
    #     exit_code = call_and_report(
    #         verb="check that aas_core3_1/__init__.py and setup.py coincide",
    #         cmd=[
    #             sys.executable,
