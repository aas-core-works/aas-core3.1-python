...
class AssetInformation(Class):
    ...
    #: Denotes whether the Asset is of kind :py:attr:`AssetKind.TYPE`,
    #: :py:attr:`AssetKind.INSTANCE`, :py:attr:`AssetKind.ROLE`, or
    #: :py:attr:`AssetKind.NOT_APPLICABLE`.
    ...
    #: In case :py:attr:`asset_kind` is :py:attr:`AssetKind.NOT_APPLICABLE` the
    #: :py:attr:`asset_type` is the asset ID of the type asset of the asset under
    #: consideration as identified by :py:attr:`global_asset_id`.
    #:
    #: .. note::
    #:
    #:     In case :py:attr:`asset_kind` is "Instance" then the :py:attr:`asset_type` denotes
...
class ValueReferencePair(Class):
    ...
    def __init__(self, value: str, value_id: Optional["Reference"] = None) -> None:
        """Initialize with the given values."""
        self.value = value
        self.value_id = value_id
