...
class TestAdministrativeInformation(unittest.TestCase):
    def test_over_embedded_data_specifications_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.AdministrativeInformation)
...
class TestAssetAdministrationShell(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.AssetAdministrationShell)
...
class TestAssetInformation(unittest.TestCase):
    def test_over_specific_asset_ids_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.AssetInformation)

            log = [
                tests.common.trace(list(instance.over_specific_asset_ids_or_empty()))
            ]
...
class TestSpecificAssetID(unittest.TestCase):
    def test_over_supplemental_semantic_ids_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.SpecificAssetID)
...
class TestRelationshipElement(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.RelationshipElement)
...
class TestSubmodelElementCollection(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.SubmodelElementCollection)
...
class TestProperty(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.Property)
...
class TestMultiLanguageProperty(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.MultiLanguageProperty)
...
class TestRange(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.Range)
...
class TestReferenceElement(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.ReferenceElement)
...
class TestBlob(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.Blob)
...
class TestFile(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.File)
...
class TestAnnotatedRelationshipElement(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.AnnotatedRelationshipElement)
...
class TestEntity(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.Entity)
...
class TestBasicEventElement(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.BasicEventElement)
...
class TestOperation(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.Operation)
    ...
    def test_over_inoutput_variables_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            log = [
                tests.common.trace(list(instance.over_inoutput_variables_or_empty()))
            ]
...
class TestCapability(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.Capability)
...
class TestConceptDescription(unittest.TestCase):
    def test_over_extensions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.ConceptDescription)
...
class TestEnvironment(unittest.TestCase):
    def test_over_asset_administration_shells_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.Environment)
    ...
    def test_over_concept_descriptions_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            log = [
                tests.common.trace(list(instance.over_concept_descriptions_or_empty()))
            ]
...
class TestDataSpecificationIEC61360(unittest.TestCase):
    def test_over_short_name_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            ...
            assert isinstance(instance, aas_types.DataSpecificationIEC61360)
