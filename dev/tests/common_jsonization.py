...
_MODEL_TYPE_TO_FROM_JSONABLE: Mapping[
    str, Callable[[aas_jsonization.Jsonable], aas_types.Class]
] = {
...
_MODEL_TYPE_TO_CLASS: Mapping[str, Type[aas_types.Class]] = {
    "AdministrativeInformation": aas_types.AdministrativeInformation,
    "AnnotatedRelationshipElement": aas_types.AnnotatedRelationshipElement,
    "AssetAdministrationShell": aas_types.AssetAdministrationShell,
    "AssetInformation": aas_types.AssetInformation,
    "BasicEventElement": aas_types.BasicEventElement,
    "Blob": aas_types.Blob,
    "Capability": aas_types.Capability,
    "ConceptDescription": aas_types.ConceptDescription,
    "DataSpecificationIec61360": aas_types.DataSpecificationIEC61360,
    "EmbeddedDataSpecification": aas_types.EmbeddedDataSpecification,
    "Entity": aas_types.Entity,
    "Environment": aas_types.Environment,
    "EventPayload": aas_types.EventPayload,
    "Extension": aas_types.Extension,
    "File": aas_types.File,
    "Key": aas_types.Key,
    "LangStringDefinitionTypeIec61360": aas_types.LangStringDefinitionTypeIEC61360,
    "LangStringNameType": aas_types.LangStringNameType,
    "LangStringPreferredNameTypeIec61360": aas_types.LangStringPreferredNameTypeIEC61360,
    "LangStringShortNameTypeIec61360": aas_types.LangStringShortNameTypeIEC61360,
    "LangStringTextType": aas_types.LangStringTextType,
    "LevelType": aas_types.LevelType,
    "MultiLanguageProperty": aas_types.MultiLanguageProperty,
    "Operation": aas_types.Operation,
    "OperationVariable": aas_types.OperationVariable,
    "Property": aas_types.Property,
    "Qualifier": aas_types.Qualifier,
    "Range": aas_types.Range,
    "Reference": aas_types.Reference,
    "ReferenceElement": aas_types.ReferenceElement,
    "RelationshipElement": aas_types.RelationshipElement,
    "Resource": aas_types.Resource,
    "SpecificAssetId": aas_types.SpecificAssetID,
    "Submodel": aas_types.Submodel,
    "SubmodelElementCollection": aas_types.SubmodelElementCollection,
    "SubmodelElementList": aas_types.SubmodelElementList,
    "ValueList": aas_types.ValueList,
    "ValueReferencePair": aas_types.ValueReferencePair,
}


def must_load(path: pathlib.Path, model_type: str) -> aas_types.Class:
    """
    ...
    """
    try:
        jsonable = json.loads(path.read_text(encoding="utf-8"))
    ...
    try:
        ...
        raise RuntimeError(
            "Failed to parse the instance " f"with model type {model_type} from {path}"
        ) from exception
