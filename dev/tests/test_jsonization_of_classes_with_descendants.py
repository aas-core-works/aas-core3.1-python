...
class TestRoundTrips(unittest.TestCase):
    def test_referable(self) -> None:
        for descendant_model_type in [
            ...
            for path in sorted(
                ...
                instance = aas_jsonization.referable_from_jsonable(original_jsonable)
    ...
    def test_identifiable(self) -> None:
        for descendant_model_type in [
            ...
            for path in sorted(
                ...
                instance = aas_jsonization.identifiable_from_jsonable(original_jsonable)
    ...
    def test_qualifiable(self) -> None:
        for descendant_model_type in [
            ...
            for path in sorted(
                ...
                instance = aas_jsonization.qualifiable_from_jsonable(original_jsonable)
    ...
    def test_relationship_element(self) -> None:
        for descendant_model_type in ["AnnotatedRelationshipElement"]:
            for path in sorted(
                (
                    tests.common.TEST_DATA_DIR
                    / "Json"
    ...
    def test_data_element(self) -> None:
        for descendant_model_type in [
            ...
            for path in sorted(
                ...
                instance = aas_jsonization.data_element_from_jsonable(original_jsonable)
    ...
    def test_event_element(self) -> None:
        for descendant_model_type in ["BasicEventElement"]:
            for path in sorted(
                (
                    tests.common.TEST_DATA_DIR
                    / "Json"
    ...
    def test_data_specification_content(self) -> None:
        for descendant_model_type in ["DataSpecificationIec61360"]:
            for path in sorted(
                (
                    tests.common.TEST_DATA_DIR
                    / "Json"
