...
.. _creating GitHub issues: https://github.com/aas-core-works/aas-core3.1-python/issues
...
.. _create a new issue: https://github.com/aas-core-works/aas-core3.1-python/issues

SDK Code Generation
===================

The code is automatically generated by `aas-core-codegen`_.
...
To update to the latest meta-model version, test data, and re-generate the code, run:

.. code-block::
    
    pip3 install --editable .
    pip3 install --editable dev/
    python dev/dev_scripts/update_all.py

The individual tasks can be also executed in separation, see `dev/dev_scripts/`_.

.. _dev/dev_scripts/: https://github.com/aas-core-works/aas-core3.1-python/tree/main/dev/dev_scripts
